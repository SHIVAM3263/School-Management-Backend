...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.teacher_id == auth_principal.teacher_id, 'This assignment is submitted to other teacher')
    ...
    @classmethod
    def get_assignment_state_by_id(cls, assignment_id):
        assignment = cls.get_by_id(assignment_id)
        return assignment.state if assignment else None
